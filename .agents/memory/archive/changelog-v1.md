...
archived_from: changelog.md
archived_on: 2026-09-20
---

# Changelog Archive v1 (Antigravity / ADK era)

Entries rotated out of `.agents/memory/changelog.md` during the Claude Code v2 checkpoint. Read only when history before the v2 port is needed.

---

## Sprint Chronology (archived)
